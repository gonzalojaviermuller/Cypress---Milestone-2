...
describe("Form fields completing", () => {
  ...
  it("Should complete all fields and submit", () => {
    ...
    practiceForm.getTableCell(1, 2).should("have.text", `${practiceForm.testValue} ${practiceForm.testValue}`);
    practiceForm.getTableCell(2, 2).should("have.text", practiceForm.testEmail);
    practiceForm.getTableCell(3, 2).should("have.text", practiceForm.testGender);
    practiceForm.getTableCell(4, 2).should("have.text", practiceForm.testPhoneNumber);
    practiceForm.getTableCell(5, 2).should("have.text", practiceForm.testBirthDate);
    practiceForm.getTableCell(6, 2).should("have.text", practiceForm.testSubject);
    practiceForm.getTableCell(7, 2).should("have.text", practiceForm.testHobbies);
    practiceForm.getTableCell(8, 2).should("have.text", practiceForm.testFile);
    practiceForm.getTableCell(9, 2).should("have.text", practiceForm.testAddress);
    practiceForm.getTableCell(10, 2).should("have.text", `${practiceForm.testState} ${practiceForm.testCity}`);
  ...
  it("Should submit with empty fields", () => {
    ...
    practiceForm.getFormField("firstName").should("have.css", "border-color", practiceForm.redBorder).type(practiceForm.testValue).should("have.css", "border-color", practiceForm.greenBorder);
    practiceForm.getFormField("lastName").should("have.css", "border-color", practiceForm.redBorder).type(practiceForm.testValue).should("have.css", "border-color", practiceForm.greenBorder);
    practiceForm
      .getFormField("email").should("be.empty")
      .type(practiceForm.testEmail);
      practiceForm.getFormField("gender", 2).click();
    practiceForm.getFormField("mobile").should("be.empty").type(practiceForm.testPhoneNumber);
    practiceForm.getSubmitBtn().click();
    practiceForm.getModalContent().should("be.visible");
    practiceForm.getTableCell(1, 2).should("have.text", `${practiceForm.testValue} ${practiceForm.testValue}`);
    practiceForm.getTableCell(2, 2).should("have.text", practiceForm.testEmail);
    practiceForm.getTableCell(3, 2).should("have.text", practiceForm.testGender);
    practiceForm.getTableCell(4, 2).should("have.text", practiceForm.testPhoneNumber);
    practiceForm.getTableCell(5, 2).should("have.text", practiceForm.currentBirthDate);
